...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.COLOR_MODE {HSV} CONFIG.C_S00_AXI_ADDR_WIDTH {10} CONFIG.NUMBER_OF_LEDS {250}  ] $DigiLED_0

  # Create instance: clk_wiz_1, and set properties
  set clk_wiz_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_1 ]
  set_property -dict [ list CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin} CONFIG.RESET_PORT {resetn} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.USE_LOCKED {false}  ] $clk_wiz_1
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins DigiLED_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins DigiLED_0/s00_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins DigiLED_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs DigiLED_0/S00_AXI/S00_AXI_reg] SEG_DigiLED_0_S00_AXI_reg
